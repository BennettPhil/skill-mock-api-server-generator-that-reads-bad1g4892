...
DEFAULT_TOPIC="A mock API server generator that reads an OpenAPI spec and spins up a local server returning realistic fake responses. Support response delays, error simulation, and stateful behavior."
DEFAULT_CONTEXT=""
